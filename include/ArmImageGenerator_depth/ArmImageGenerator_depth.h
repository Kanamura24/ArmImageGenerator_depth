// -*- C++ -*-
/*!
 * @file  ArmImageGenerator_depth.h
...
#ifndef ARMIMAGEGENERATOR_DEPTH_H
#define ARMIMAGEGENERATOR_DEPTH_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ArmImageGenerator_depth(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~ArmImageGenerator_depth();
...
extern "C"
{
  DLL_EXPORT void ArmImageGenerator_depthInit(RTC::Manager* manager);
};

#endif // ARMIMAGEGENERATOR_DEPTH_H
