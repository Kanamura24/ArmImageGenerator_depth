// -*- C++ -*-
/*!
 * @file  ArmImageGenerator_depth.cpp
...
#include "ArmImageGenerator_depth.h"
...
static const char* armimagegenerator_depth_spec[] =
  {
    "implementation_id", "ArmImageGenerator_depth",
 ...
 */
ArmImageGenerator_depth::ArmImageGenerator_depth(RTC::Manager* manager)
 ...
 * @brief destructor
 */
ArmImageGenerator_depth::~ArmImageGenerator_depth()
{
}



RTC::ReturnCode_t ArmImageGenerator_depth::onInitialize()
{
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onFinalize()
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t ArmImageGenerator_depth::onActivated(RTC::UniqueId ec_id)
{
	...
	while (true) {
      //int ok_count = 0;
 		...
 		if (pp.connector_profiles.length() > 0) {
 			...
 			if (std::string(cp0->type_name) == armimagegenerator_depth_spec[1]) {
...
RTC::ReturnCode_t ArmImageGenerator_depth::onDeactivated(RTC::UniqueId ec_id)
{
 	m_jointPos[0] = 0;
 	m_jointPos[1] = 0;
 	m_jointPos[2] = M_PI/2;
...
RTC::ReturnCode_t ArmImageGenerator_depth::onExecute(RTC::UniqueId ec_id)
{
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ArmImageGenerator_depth::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
extern "C"
{
  ...
  void ArmImageGenerator_depthInit(RTC::Manager* manager)
  {
    coil::Properties profile(armimagegenerator_depth_spec);
    manager->registerFactory(profile,
                             RTC::Create<ArmImageGenerator_depth>,
                             RTC::Delete<ArmImageGenerator_depth>);
  }
